...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_9pq5sst', 'template_bk68ek9', formRef.current, {
            publicKey: '8uiglYijIYvXRPwIE',
          })
          .then(
            (result) => {
                setSuccess(true)
        ...
        <motion.div ref={ref} className="contact" variants={variants} initial="initial" whileInView="animate">
            <motion.div className="textContainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>ankitasrivastava2141@gmail.com</span>
                </motion.div>
...
{/*                 <motion.div className="item" variants={variants}>
    ...
    <svg viewBox="0 0 32.666 32.666" preserveAspectRatio="xMidYMid meet">
        <motion.path
            strokeWidth={0.2}
            fill="none"
